/**
 * @license AngularJS v1.3.0-beta.2-build.local+sha.f9a0572
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.0-beta.2-build.local+sha.f9a0572/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.0-beta.2-build.local+sha.f9a0572',    // all of these placeholder strings will be replaced by grunt's
...
function jqLiteInheritedData(element, name, value) {
  ...
  while (element.length) {
    ...
    if (!parent.length) {
      ...
      else if (element[0].nodeType === 11) parent = jqLite(element[0].host);
    }
    element = parent;
  }
}
